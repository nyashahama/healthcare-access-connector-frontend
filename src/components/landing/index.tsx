...
import FeaturesPlanet from "@/views/landing/FeaturesPlanet";
import HowItWorks from "@/views/landing/HowItWorks";
import LargeTestimonial from "@/views/landing/LargeTestimonial";
...
export default function LandingPage() {
  const [activeFaq] = useState<string | null>(null);
