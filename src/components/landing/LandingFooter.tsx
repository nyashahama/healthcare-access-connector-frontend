...
export default function LandingFooter({ border = false }: LandingFooterProps) {
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link
                  className="text-gray-600 transition hover:text-blue-600"
                  to={'/provider/appointments' as any}
                >
                  Manage Appointments
                </Link>
              </li>
              <li>
                <Link
                  className="text-gray-600 transition hover:text-blue-600"
                  to={'/provider/telemedicine' as any}
                >
                  Telemedicine
                </Link>
              </li>
              <li>
                <Link
                  className="text-gray-600 transition hover:text-blue-600"
                  to={'/provider/clinic-management' as any}
                >
