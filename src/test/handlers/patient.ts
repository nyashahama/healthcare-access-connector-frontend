...
interface CreatePatientHandlersReturn {
  handlers: RestHandler[];
  setProfileCompletion: (value: number) => void;
  setReturn401: (value: boolean) => void;
}

export const createPatientHandlers = (): CreatePatientHandlersReturn => {
  ...
  return {
    ...
    setProfileCompletion: (value: number) => {
      profileCompletion = value;
    },
    setReturn401: (value: boolean) => {
