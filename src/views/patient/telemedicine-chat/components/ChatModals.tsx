...
export const EndChatModal = ({ isOpen, onClose, onConfirm }: any) => (
...
export const VideoCallModal = ({ isOpen, onClose, provider, onConfirm }: any) => (
  <Modal isOpen={isOpen} onClose={onClose}>
    <div className="p-6">
      <div className="mb-4 flex items-center">
...
export const AttachFileModal = ({ isOpen, onClose, onFileSelect }: any) => {
  const fileTypes = [
    {
      id: "photo",
      name: "Photo",
...
export const RatingModal = ({ isOpen, onClose, provider, onSubmit }: any) => {
