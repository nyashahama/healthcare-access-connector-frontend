...
const QuickActions = () => {
  ...
  const actions = [
    {
      ...
      onClick: () => setModalState((prev: any) => ({ ...prev, findClinic: true })),
    },
    {
      icon: <FaStethoscope />,
      ...
      onClick: () =>
        setModalState((prev: any) => ({ ...prev, checkSymptoms: true })),
    },
    {
      ...
      onClick: () => setModalState((prev: any) => ({ ...prev, chatDoctor: true })),
    },
    {
      icon: <FaAppleAlt />,
      ...
      onClick: () =>
        setModalState((prev: any) => ({ ...prev, nutritionTips: true })),
    },
  ];

  const handleClinicFind = () => {
    setModalState((prev: any) => ({ ...prev, findClinic: false }));
  ...
  const handleSymptomStart = () => {
    setModalState((prev: any) => ({ ...prev, checkSymptoms: false }));
  ...
  const handleChatStart = () => {
    setModalState((prev: any) => ({ ...prev, chatDoctor: false }));
  ...
  const handleNutritionOpen = () => {
    setModalState((prev: any) => ({ ...prev, nutritionTips: false }));
    showToast("Opening nutrition guide...", "info");
    setTimeout(() => {
      navigate({ to: "/patient/nutrition" });
    }, 1000);
  };
