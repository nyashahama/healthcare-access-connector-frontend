...
const EmergencyContact = () => {
  ...
  const confirmSave = () => {
    if (actionType === "edit") {
      ...
      setEmergencyContacts((prev: any) => [...prev, newContact]);
  ...
  const confirmDelete = () => {
    setEmergencyContacts((prev: any) =>
      prev.filter((contact: any) => contact.id !== selectedContact.id)
    );
  ...
  const setPrimaryContact = (id: any) => {
    setEmergencyContacts((prev: any) =>
      prev.map((contact: any) => ({
        ...contact,
