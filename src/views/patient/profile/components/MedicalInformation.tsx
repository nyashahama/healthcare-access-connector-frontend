...
const MedicalInformation = () => {
  ...
  const handleFormChange = (formSetter: any) => (field, value) => {
      ...
      <Card extra={"w-full h-full p-6"}>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="space-y-2">
                {medicalData.allergies.map((allergy: any) => (
                  <div
                    key={allergy.id}
          ...
          <div>
            ...
            <div className="space-y-3">
              {medicalData.medications.map((med: any) => (
                <div
                  key={med.id}
            ...
            <div className="mt-6">
              ...
              <div className="space-y-2">
                {medicalData.conditions.map((condition: any) => (
                  <div
                    key={condition.id}
