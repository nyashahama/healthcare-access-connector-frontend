...
const PatientDashboard = () => {
  ...
  const handleAppointmentClick = () => {
    if (upcomingCount > 0) {
      setModalState((prev: any) => ({ ...prev, appointmentReminder: true }));
    } else {
  ...
  const handleHealthScoreClick = () => {
    setModalState((prev: any) => ({ ...prev, healthScoreDetails: true }));
  };

  const handleEmergencyClick = () => {
    setModalState((prev: any) => ({ ...prev, emergencyContacts: true }));
  };

  const handleNutritionClick = () => {
    setModalState((prev: any) => ({ ...prev, nutritionTipDetails: true }));
    setSelectedTip({
  ...
  const handleSymptomCheckerClick = () => {
    ...
    setTimeout(() => {
      navigate({ to: "/patient/symptom-checker" });
    }, 1000);
  };
  ...
  return (
    <div>
      ...
      <AppointmentReminderModal
        ...
        onClose={() =>
          setModalState((prev: any) => ({ ...prev, appointmentReminder: false }))
        }
      ...
      <HealthScoreModal
        ...
        onClose={() =>
          setModalState((prev: any) => ({ ...prev, healthScoreDetails: false }))
        }
      />
      ...
      <EmergencyContactsModal
        ...
        onClose={() =>
          setModalState((prev: any) => ({ ...prev, emergencyContacts: false }))
        }
      />
      ...
      <NutritionTipModal
        ...
        onClose={() =>
          setModalState((prev: any) => ({ ...prev, nutritionTipDetails: false }))
        }
        tip={selectedTip}
        showToast={showToast}
      />
