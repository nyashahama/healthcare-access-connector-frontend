...
export const HealthScoreModal = ({ isOpen, onClose }: any) => (
  <Modal
    isOpen={isOpen}
    onClose={onClose}
...
export const EmergencyContactsModal = ({ isOpen, onClose }: any) => (
...
export const NutritionTipModal = ({ isOpen, onClose, tip, showToast }: any) => {
  const navigate = useNavigate();
  return (
  <Modal
    isOpen={isOpen}
