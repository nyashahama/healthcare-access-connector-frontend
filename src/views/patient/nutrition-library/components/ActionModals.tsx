...
export const SaveOfflineModal = ({ isOpen, onClose, article, onConfirm }: any) => (
...
export const ShareArticleModal = ({ isOpen, onClose, article, onShare }: any) => {
  const shareMethods = [
    ...
    <div className="p-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="space-y-2">
            {["All", "Under 5 min", "5-10 min", "Over 10 min"].map((time: any) => (
...
export const SMSSubscribeModal = ({ isOpen, onClose, onConfirm }: any) => (
  <Modal isOpen={isOpen} onClose={onClose}>
    <div className="p-6">
      <h3 className="mb-6 text-xl font-bold text-navy-700 dark:text-white">
