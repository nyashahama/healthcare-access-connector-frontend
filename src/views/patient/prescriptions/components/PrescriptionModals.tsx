...
// ===== Refill Modal =====
export const RefillModal = ({ isOpen, onClose, prescription, onConfirm }: any) => {
...
// ===== Share Modal =====
export const ShareModal = ({ isOpen, onClose, prescription, onConfirm }: any) => {
...
// ===== Download Modal =====
export const DownloadModal = ({ isOpen, onClose, prescription, onConfirm }: any) => {
...
// ===== Print Modal =====
export const PrintModal = ({ isOpen, onClose, prescription, onConfirm }: any) => {
  if (!prescription) return null;
...
export const NewRequestModal = ({ isOpen, onClose, onConfirm }: any) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="lg">
      <div className="space-y-6 py-4">
        <div className="text-center">
