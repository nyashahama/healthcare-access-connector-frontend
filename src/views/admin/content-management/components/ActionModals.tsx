...
export const DeleteModal = ({ isOpen, onClose, article, confirmDelete }: any) => (
...
export const PublishModal = ({ isOpen, onClose, article, confirmPublish }: any) => (
...
export const PreviewModal = ({ isOpen, onClose, article }: any) => (
