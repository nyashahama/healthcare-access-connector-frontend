...
const SystemDashboard = () => {
  ...
  const handleRestartSystem = (system: any) => {
    setSelectedSystem(system);
    setRestartModalOpen(true);
  };

  const handleBackupSystem = (system: any) => {
    setSelectedSystem(system);
    setBackupModalOpen(true);
  };

  const handleViewDetails = (system: any) => {
    setSelectedSystem(system);
    showToast(`Viewing details for ${system}`, "info");
  };

  const handleApproveClinic = (clinic: any) => {
    setSelectedClinic(clinic);
    setApproveClinicModalOpen(true);
  };

  const handleRejectClinic = (clinic: any) => {
    setSelectedClinic(clinic);
