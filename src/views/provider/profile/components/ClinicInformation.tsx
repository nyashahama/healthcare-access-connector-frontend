...
const ClinicInformation = ({ clinicId }: any) => {
  ...
  const formatClinicType = (type: any) => {
    if (!type) return "";
    return type
      .split("_")
  ...
  const formatLanguage = (langCode: any) => {
    const langMap = {
      en: "English",
      zu: "Zulu",
      af: "Afrikaans",
  ...
  const handleFacilityAdd = (facility: any) => {
  ...
  const handleFacilityRemove = (facilityToRemove: any) => {
    setEditForm({
      ...editForm,
      facilities: editForm.facilities.filter((f: any) => f !== facilityToRemove),
    });
  };
  ...
  const handleLanguageRemove = (languageToRemove: any) => {
    setEditForm({
      ...editForm,
      languages: editForm.languages.filter((l: any) => l !== languageToRemove),
    });
  };
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="mb-3 flex flex-wrap gap-2">
              {editForm.facilities.map((facility: any, index: number) => (
                <span
                  key={index}
            ...
            <div className="flex gap-2">
              <input
                ...
                onKeyPress={(e) => {
                  if (e.key === "Enter") {
                    handleFacilityAdd(
                      (e.target as HTMLInputElement).value.toLowerCase().replace(/ /g, "_")
                    );
          ...
          <div>
            ...
            <div className="mb-3 flex flex-wrap gap-2">
              {editForm.languages.map((language: any, index: number) => (
                <span
                  key={index}
          ...
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {clinicInfo.facilities.length > 0 ? (
                clinicInfo.facilities.map((facility: any, index: number) => (
                  <span
                    key={index}
          ...
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {clinicInfo.languages.length > 0 ? (
                clinicInfo.languages.map((language: any, index: number) => (
                  <span
                    key={index}
          ...
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {clinicInfo.payment_methods.length > 0 ? (
                clinicInfo.payment_methods.map((method: any, index: number) => (
                  <span
                    key={index}
