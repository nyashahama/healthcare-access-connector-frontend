  ...
  return (
    <Card extra="p-6">
      ...
      <div className="space-y-3">
        <button
          onClick={() => navigate({ to: "/provider/telemedicine" as any })}
        ...
        <button
          onClick={() => navigate({ to: "/provider/appointments" as any })}
          className="flex w-full items-center justify-between rounded-lg border border-gray-200 p-3 hover:bg-gray-50 dark:border-gray-700"
        >
          <div className="flex items-center">
        ...
        <button
          onClick={() => navigate({ to: "/patient/prescriptions" })}
          className="flex w-full items-center justify-between rounded-lg border border-gray-200 p-3 hover:bg-gray-50 dark:border-gray-700"
        >
          <div className="flex items-center">
...
export const PrescriptionPadCard = ({ onIssuePrescription }: any) => {
  return (
    <Card extra="p-6">
