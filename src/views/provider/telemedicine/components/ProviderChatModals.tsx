...
// --- Prescription Modal ---
export const PrescriptionModal = ({ isOpen, onClose, patient, onConfirm }: any) => {
  ...
  const handleChange = (field: any) => (e) =>
...
// --- Referral Modal ---
export const ReferralModal = ({ isOpen, onClose, patient, onConfirm }: any) => {
  const [form, setForm] = React.useState({
    specialist: "",
    facility: "",
    reason: "",
...
// --- Lab Order Modal ---
export const LabOrderModal = ({ isOpen, onClose, patient, onConfirm }: any) => {
  ...
  const toggleTest = (test: any) => {
    setSelectedTests((prev: any) =>
      prev.includes(test) ? prev.filter((t: any) => t !== test) : [...prev, test]
    );
  };
