...
// ===== Add Patient Modal =====
export const AddPatientModal = ({ isOpen, onClose, onConfirm }: any) => {
...
// ===== Clear Queue Modal =====
export const ClearQueueModal = ({ isOpen, onClose, onConfirm }: any) => (
...
export const CallNextModal = ({ isOpen, onClose, onConfirm }: any) => (
...
// ===== Mark All Seen Modal =====
export const MarkAllSeenModal = ({ isOpen, onClose, onConfirm }: any) => (
