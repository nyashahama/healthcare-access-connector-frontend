          ...
          {postData.category && (
            <div className="mt-2 flex gap-2">
              <span className="rounded-full bg-gray-100 px-3 py-1 text-sm dark:bg-gray-800">
                {categories.find((c: any) => c.id === postData.category)?.name}
              </span>
              {postData.caseType && (
          ...
          {postData.conditions.length > 0 && (
            <div className="mt-3">
              ...
              <div className="mt-1 flex flex-wrap gap-1">
                {postData.conditions.map((condition: any) => (
                  <span
                    key={condition}
              ...
              {postData.category === "case-discussions" && (
                <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                  ...
                  <div className="mt-3">
                    ...
                    <div className="flex gap-2">
                      {["routine", "urgent", "emergent"].map((level: any) => (
                        <button
                          key={level}
                          type="button"
                          onClick={() =>
              ...
              <div>
                ...
                {postData.references.length > 0 && (
                  <div className="mt-3 space-y-1">
                    {postData.references.map((ref: any, idx: number) => (
                      <div
                        key={idx}
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() =>
                            setPostData({
                              ...postData,
                              tags: postData.tags.filter((t: any) => t !== tag),
                            })
                          }
